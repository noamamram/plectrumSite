...
const content = {
  ...
  he: {
    title: "תחושה פיזית חכמה נשלטת מרחוק.",
    subtitle:
      "מערכת חכמה להעברת תחושת מגע מרחוק. Plectrum מחברת בין העולם הדיגיטלי לפיזי בעזרת לבוש טכנולוגי חכם, המעביר תחושות פיזיות לגוף, לשיפור הטיפול והחוויה הדיגיטלית.",
