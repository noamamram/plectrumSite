...
const content = {
  ...
  he: {
    ...
    subtitle:
      "מערכת לבישה חכמה להעברת תחושת מגע פיזיות מרחוק. Plectrum מחברת בין העולם הדיגיטלי לפיזי בעזרת לבוש טכנולוגי חכם, המעביר תחושות מגע פיזיות לגוף, לשיפור הטיפול והחוויה הדיגיטלית מבוססי גריה חושית פיזית.",
