...
const content = {
  ...
  he: {
    title: "מגע חכם מרחוק.",
    subtitle:
      "מערכת חכמה להעברת תחושת מגע באמצעות תוכנה. Plectrum מחברת בין העולם הדיגיטלי לפיזי בעזרת ביגוד חכם שמעביר תחושות מדויקות לגוף, לשיפור הטיפול והחוויה הדיגיטלית.",
    explore: "גלו את הטכנולוגיה",
    partner: "שותפות עם Plectrum",
    scroll: "גללו מטה לפרטים",
    thesisEyebrow: "המימד החסר",
    thesisTitle: "העולם הדיגיטלי יודע לראות ולשמוע. עכשיו הוא גם יודע לגעת.",
    thesisBody:
      "מגע הוא חלק חיוני בטיפול ובתקשורת. Plectrum הופכת את המגע למידע דיגיטלי שניתן למדוד ולשלוט בו מרחוק בעזרת תוכנה.",
    sense: "איסוף נתונים",
    senseBody: "איסוף נתוני גוף ומדדים דרך הבגד החכם.",
    analyze: "ניתוח",
    analyzeBody: "התאמה אישית של הטיפול לפי צרכי המשתמש.",
    respond: "פעולה",
    ...
    productsBody:
      "אבות הטיפוס שלנו משתמשים ברטט מדויק כדי לבחון את מערכת התוכנה ואת תהליכי הטיפול, כצעד מקדים לטכנולוגיית הבד האקטיבי שפיתחנו.",
    products: [
      ["חולצה", "מגע מרגיע לפלג הגוף העליון בעזרת מנועי רטט זעירים ונשלטים."],
      ["שרוול", "תחושה ממוקדת לידיים בעזרת רטט מדויק ונשלט."],
      ["כובע", "מגע עדין באזור הראש המסייע בהפחתת לחץ."],
      ["כפפה", "הכוונת תנועה בעזרת רטט לשיפור מוטוריקה עדינה."],
    ],
    viewModels: "צפו באבות הטיפוס שלנו",
    tractionEyebrow: "התקדמות",
    tractionTitle: "אבות טיפוס פועלים כיום. טכנולוגיית בד אקטיבי בעתיד הקרוב.",
    traction: [
      ["4", "אבות טיפוס פעילים"],
    ...
    partnerLine:
      "שותפות קלינית עם בית החולים הדסה ופיתוח משותף עם IBM.",
    futureEyebrow: "הטכנולוגיה שלנו",
    futureTitle: "הדור הבא של מגע: בד אקטיבי (Fabtive).",
    futureBody:
      "הטכנולוגיה שלנו מבוססת על סיבים חכמים המשולבים בתוך בד רגיל. השילוב יוצר משטח רציף המאפשר להעביר תחושת מגע אמיתית על פני כל הבגד, ללא תלות ברטט נקודתי.",
