...
const copy = {
 en: {
    eyebrow: "COMPANY",
    title: "Building the tactile layer of digital wellness.",
    intro:
      "Plectrum combines software, professional support practices, and wearable functional prototypes to make physical sensory support measurable, controllable, and remotely accessible, while developing FABTIVE, a patented active-fabric platform for continuous physical sensation.",
    tractionLabel: "WHERE WE ARE",
    tractionTitle: "Working prototypes today. Active Fabric Patented platform ahead.",
    milestones: [
      ["4", "working vibration-based wearable prototypes"],
      ["2026", "global pilot program expansion"],
    ...
    relationshipsTitle: "Professional and technical momentum.",
    relationships: [
      ["Hadassah", "Signed Letter of Intent."],
      ["TEFRON", "Signed NDA, MOU established."],
      ["AKIM", "Signed Letter of Intent."],
      ["RayQ", "Signed NDA, MOU established."],
      ["Aleh", "Signed Letter of Intent."],     
    ],
    marketLabel: "COMMERCIAL PATH",
    marketTitle: "A focused entry into a measurable market.",
    marketBody:
      "Plectrum's current model focuses on pediatric sensory and wellness centers in the United States. The opportunity is built from four clear commercial assumptions:",
    marketMetrics: [
      ["~5,000", "pediatric sensory support centers in the United States"],
      ["$450", "monthly revenue per user"],
      ["$135", "monthly technology share per user"],
    ...
    team: [
      ...
      },
      {
        ...
        role: "Head of Science & Materials",
        credential: "PhD",
        bio: "Deep-tech expertise in advanced materials and coatings, with extensive wearable and human-centric device R&D experience spanning polymerization, innovative coating methods, scale-up, and manufacturing.",
      ...
      },
      {
        ...
        bio: "Specialized in digital board design and reverse engineering, with a background in high-stakes military and precision electronics. A key technical leader overseeing embedded firmware development and controller programming.",
    ...
    paths: [
      ...
      ["Professional partners", "Pilot design for wellness centers and support organizations.", "Explore a professional pilot", "Plectrum professional pilot"],
  ...
  he: {
    eyebrow: "החברה",
    title: "בונים את שכבת המגע לחוויית הרווחה הדיגיטלית.",
    intro:
      "Plectrum מחברת בין תוכנה, פרקטיקות תמיכה מקצועיות ואבות טיפוס לבישים כדי להפוך תמיכה חושית פיזית למדידה, נשלטת ונגישה מרחוק, ובמקביל מפתחת את FABTIVE, פלטפורמת בד אקטיבי פטנטית לתחושה פיזית רציפה.",
    tractionLabel: "איפה אנחנו היום",
    tractionTitle: "אבות טיפוס פעילים כיום. פטנט פלטפורמת בד אקטיבי בהמשך.",
    milestones: [
      ["4", "אבות טיפוס לבישים ופעילים המבוססים על רטט"],
      ["2026", "הרחבת תוכניות פיילוט בעולם"],
      ["$2M", "סבב הגיוס הנוכחי"],
      ["ישראל · ארה״ב · אירופה", "פטנט אושר בישראל; ארה״ב ואירופה בתהליך"],
    ],
    relationshipsLabel: "אימות וקשרים",
    relationshipsTitle: "תנופה מקצועית וטכנולוגית.",
    relationships: [
      ["הדסה", "מכתב כוונות חתום."],
      ["TEFRON", "נחתם NDA גובש מסמך הבנות."],
      ["עמותת אקים", "מכתב כוונות חתום."],
      ["RayQ", "נחתם NDA גובש מסמך הבנות."],
      ["עמותת עלה", "מכתב כוונות חתום."],
    ],
    marketLabel: "המסלול המסחרי",
    marketTitle: "כניסה ממוקדת לשוק מדיד.",
    marketBody:
      "המודל הנוכחי של Plectrum מתמקד במרכזי ויסות ורווחה (Wellness) לילדים בארצות הברית. ההזדמנות נשענת על ארבע הנחות מסחריות ברורות:",
    marketMetrics: [
      ["~5,000", "מרכזי תמיכה חושית לילדים בארצות הברית"],
      ["$450", "הכנסה חודשית למשתמש"],
      ["$135", "חלק טכנולוגי חודשי למשתמש"],
    ...
    team: [
      ...
      {
        name: "Dr. Nino Rivka Eliahu",
        role: "מובילת תחום מדע וחומרים",
        credential: "PhD",
        bio: "מומחיות דיפ־טק בפיתוח חומרים וציפויים מתקדמים. ניסיון נרחב במחקר ופיתוח של מכשור לביש מתקדם, בפולימריזציה ובשיטות ציפוי חדשניות, וכן בהגדלת קנה מידה ובייצור.",
        image: "/team/nino-rivka-eliahu-neutral.png",
        icon: "/team/icons/nino-materials.svg",
        linkedin: "https://www.linkedin.com/in/dr-nino-rebecca-eliahu-65037851/",
      },
      ...
      },
      {
        ...
        bio: "בעל ניסיון ייחודי בתכנון כרטיסים דיגיטליים ובהנדסה לאחור, עם רקע באלקטרוניקה צבאית ואלקטרוניקה מדויקת למערכות מתקדמות בסביבות עתירות סיכון. מוביל טכנולוגי מרכזי האחראי גם על פיתוח קושחה משובצת ותכנות בקרים.",
        image: "/team/omri-arbel-neutral.png",
        icon: "/team/icons/omri-cpu.svg",
        linkedin: "https://www.linkedin.com/in/omri-arbel-345796195/",
      },
    ...
    paths: [
      ...
      ["שותפים מקצועיים", "בניית פיילוט למרכזי רווחה וארגונים תומכים.", "בדיקת פיילוט מקצועי", "פיילוט מקצועי עם Plectrum"],
